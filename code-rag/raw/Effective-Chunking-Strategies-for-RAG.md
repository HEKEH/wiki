---
created: 2026-05-05T22:45:05 (UTC +08:00)
tags: [Cohere,retrieval-augmented generation,RAG]
source: https://docs.cohere.com/page/chunking-strategies
author: Ania Bialas
---
...
In this example we will work with a 2023 Tesla earning call transcript.
...
Indeed, by printing the cited chunk, we can validate that the text was divided so that the generation model could not provide the correct response. Notably, the speaker’s name is not included in the context, which is why the model refers to an `unknown speaker`.
