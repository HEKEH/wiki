...
![img](/files/YUPG4Rawdb3sL6c4CPts)
...
![img](/files/wwtvN3kQxlmNWdPYbe2P)

POST 请求的处理过程为：

![img](/files/-MYSlHYID7N1kO8n43Mc)

## API 访问

有多种方式可以访问 Kubernetes 提供的 REST API：

* [kubectl](/concepts/components/kubectl.md) 命令行工具
* SDK，支持多种语言
